...
class WeatherApi {
  ...
  /// 
  ///
  /// get current wearther data by coordinates
  Future<WeatherGetResponse> weatherGet(double lat, double lon, String appid, String units) async {
    ...
    String path = "/weather".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'WeatherGetResponse') as WeatherGetResponse ;
    } else {
      return null;
    }
  }
